...
- `boxd-subagents` — delegate coding tasks to forked boxd VMs using the existing `codex-base`, `claude-base`, or `pi-base`, resume native sessions, and collect results without terminal automation.
